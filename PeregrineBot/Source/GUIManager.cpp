...
void GUIManager::drawTextOnScreen(BWAPI::Unit unit, const std::string& format, int frames)
{
...
void GUIManager::drawTextOnUnit(BWAPI::Unit unit, const std::string& format)
{
	if (!unit->exists()) {
		return;
	}
